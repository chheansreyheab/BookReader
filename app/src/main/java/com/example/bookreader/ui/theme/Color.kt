...
// Light theme colors
val md_theme_light_primary = Color(0xFFAD1010)          // Deep Red
val md_theme_light_onPrimary = Color(0xFFFFFFFF)        // White text on primary
val md_theme_light_primaryContainer = Color(0xFFFFDADA) // Light red background container
...
val md_theme_light_tertiary = Color(0xFFEFB8C8)
val md_theme_light_onTertiary = Color(0xFF442532)
val md_theme_light_tertiaryContainer = Color(0xFFFFD9E0)
val md_theme_light_onTertiaryContainer = Color(0xFF3E0017)
...
val md_theme_dark_tertiary = Color(0xFFF1B8C9)
val md_theme_dark_onTertiary = Color(0xFF632533)
val md_theme_dark_tertiaryContainer = Color(0xFF853B4A)
